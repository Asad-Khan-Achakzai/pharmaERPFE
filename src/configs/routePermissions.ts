...
export const routePermissions: Array<{ path: string; permission: string }> = [
  ...
  { path: '/settlements/remittance', permission: 'payments.create' },
  { path: '/settlements/remittances', permission: 'payments.view' },
  ...
  { path: '/ai-copilot', permission: 'copilot.use' },
  ...
  { path: '/team/field-days', permission: 'managerFieldDays.view' },
  { path: '/team/route-history', permission: 'team.view' },
